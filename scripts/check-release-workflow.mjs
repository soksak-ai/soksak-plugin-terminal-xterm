...
for (const target of ["preflight", "prepare", "build", "verify", "require-tooling", "require-out", "release", "attest"]) {
  if (!new RegExp(`^${target}:`, "m").test(makefile)) throw new Error(`Makefile target is missing: ${target}`);
}
for (const boundary of [
  "SDK_ROOT", "SDK_RELEASE", "OUT", "bin/soksak-sdk.mjs",
  ".dependencies/soksak-spec/release-template/verify-plugin-release.mjs",
]) {
